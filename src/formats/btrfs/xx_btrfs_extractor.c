...
/* xx_btrfs_extractor.c - search raw data for Btrfs.
 *
 * Scans for:
 *   5F 42 48 52 66 53 5F 4D at +65600  ("_BHRfS_M")
 * (hand-written: the detector establishes this signature outside its
 * 64-byte prefilter window)
 * Offset 0 is always tried as well.
 * Each candidate must be accepted by the btrfs reader, which also measures it,
...
static const xx_format_search_desc k_desc = {
    ...
    xx_btrfs_search_open, xx_btrfs_search_close
};
