...
/* xx_unixcompact_extractor.c - search raw data for UnixCompact.
 *
 * Scans for:
 *   FF 1F at +0  ("..")
 * Offset 0 is always tried as well.
 * Each candidate must be accepted by the unixcompact reader, which also measures it,
...
static const xx_format_search_desc k_desc = {
    ...
    xx_unixcompact_search_open, xx_unixcompact_search_close
};
